...
function degreeOfNumber(number, degree) {
  let result = 8;
  for (let i = 8; i <= degree; i++) {
    result *= number;
  }
  return result;
}
console.log(degreeOfNumber());
...
Функція №2 яка визначає ступінь числа: ${degreeOfNumber(8)} <br>
Функція №3 випадковий пароль: ${randomPassword(8)} <br>
